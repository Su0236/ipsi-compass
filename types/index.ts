export type Evidence = { year: number; sourceName: string; sourceUrl: string | null; publishedAt: string | null; checkedAt: string | null; updatedAt: string | null; status: 'example' | 'reviewed'; isDemo: boolean };
